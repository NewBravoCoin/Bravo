...
RESOURCES += src/qt/brv.qrc src/qt/brv_locale.qrc

TRANSLATIONS += src/qt/locale/brv_bg.ts \
                src/qt/locale/brv_de.ts \
                src/qt/locale/brv_en.ts \
                src/qt/locale/brv_es.ts \
                src/qt/locale/brv_fi.ts \
                src/qt/locale/brv_fr.ts \
                src/qt/locale/brv_it.ts \
                src/qt/locale/brv_ja.ts \
                src/qt/locale/brv_pl.ts \
                src/qt/locale/brv_pt.ts \
                src/qt/locale/brv_ru.ts \
                src/qt/locale/brv_sk.ts \
                src/qt/locale/brv_sv.ts \
                src/qt/locale/brv_vi.ts \
                src/qt/locale/brv_zh_CN.ts \
                src/qt/locale/brv_zh_TW.ts
