                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bravo-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BRV address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and brv: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BRV Core"), this);
    aboutAction->setStatusTip(tr("Show information about BRV Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BRV"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BRV addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BRV addresses"));
    ...
    openAction->setStatusTip(tr("Open a BRV: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BRV Core help message to get a list with possible BRV command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BRV Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BRV network", "", count));
}
...
{
    QString strTitle = tr("BRV Core"); // default title
