...
#if defined(NDEBUG)
#error "BRV cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BRV Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(nHeight <= 1 && nHeight > 0) {
		...
		nSubsidy = 0.5 * COIN;
	} else if (nHeight > 2000 && nHeight <= 43200) {
		nSubsidy = 200 * COIN; 
		...
		nSubsidy = 100 * COIN;
	} else if (nHeight > 525600 && nHeight <= 784800) {
		nSubsidy = 80 * COIN;
	} else if (nHeight > 784800 && nHeight <= 1051200) {
		nSubsidy = 50 * COIN;
