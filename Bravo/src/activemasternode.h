...
// Copyright (c) 2015-2016 The Bravo developers
...
private:
    ...
    /// Get 10000 BRV input that can be used for the Masternode
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 BRV - checking if valid masternode)
