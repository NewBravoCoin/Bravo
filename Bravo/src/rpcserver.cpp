...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BRV features */
        {"brv", "masternode", &masternode, true, true, false},
        {"brv", "masternodelist", &masternodelist, true, true, false},
        {"brv", "mnbudget", &mnbudget, true, true, false},
        {"brv", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"brv", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"brv", "mnsync", &mnsync, true, true, false},
        {"brv", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use brvd, or the -server option to brv-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> brv-cli " + methodname + " " + args + "\n";
}
