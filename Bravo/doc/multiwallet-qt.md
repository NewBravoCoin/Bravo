...
In order to support loading of multiple wallets in brv-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is brv.cpp.
...
Changes to brv.cpp
----------------------
brv.cpp is the entry point into brv-qt, and as such, will require some minor modifications to provide hooks for
